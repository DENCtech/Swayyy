define("Swayyy.clientVariables", ["OutSystems/ClientRuntime/Main"], function (OutSystems) {
...
return clientVarsService.getVariable("Username", "Swayyy", OS.Types.Text);
};
ClientVariables.prototype.setUsername = function (value) {
return clientVarsService.setVariable("Username", "Swayyy", OS.Types.Text, value);
};
