define("Swayyy.Common.Layout.mvc$model", ["OutSystems/ClientRuntime/Main", "Swayyy.model", "OutSystemsUI.controller", "OutSystemsUI.Private.PullToRefresh.mvc$model", "Swayyy.Common.OfflineDataSyncEvents.mvc$model", "OutSystemsUI.controller$AddFavicon", "Swayyy.referencesHealth", "Swayyy.referencesHealth$OutSystemsUI", "OutSystemsUI.controller$LayoutReady", "OutSystemsUI.controller$SetLang", "OutSystemsUI.controller$SkipToContent"], function (OutSystems, SwayyyModel, OutSystemsUIController, OutSystemsUI_Private_PullToRefresh_mvcModel, Swayyy_Common_OfflineDataSyncEvents_mvcModel) {
...
return SwayyyModel.staticEntities.sideMenuBehavior.overlay;
}, false), 
...
Model._hasValidationWidgetsValue = (OutSystemsUI_Private_PullToRefresh_mvcModel.hasValidationWidgets || Swayyy_Common_OfflineDataSyncEvents_mvcModel.hasValidationWidgets);
}
...
define("Swayyy.Common.Layout.mvc$view", ["OutSystems/ClientRuntime/Main", "Swayyy.model", "Swayyy.controller", "OutSystemsUI.controller", "react", "OutSystems/ReactView/Main", "Swayyy.Common.Layout.mvc$model", "Swayyy.Common.Layout.mvc$controller", "Swayyy.clientVariables", "OutSystems/ReactWidgets/Main", "OutSystemsUI.Private.PullToRefresh.mvc$view", "Swayyy.Common.OfflineDataSyncEvents.mvc$view", "OutSystemsUI.controller$AddFavicon", "Swayyy.referencesHealth", "Swayyy.referencesHealth$OutSystemsUI", "OutSystemsUI.controller$LayoutReady", "OutSystemsUI.controller$SetLang", "OutSystemsUI.controller$SkipToContent"], function (OutSystems, SwayyyModel, SwayyyController, OutSystemsUIController, React, OSView, Swayyy_Common_Layout_mvc_model, Swayyy_Common_Layout_mvc_controller, SwayyyClientVariables, OSWidgets, OutSystemsUI_Private_PullToRefresh_mvc_view, Swayyy_Common_OfflineDataSyncEvents_mvc_view) {
    var OS = OutSystems.Internal;
...
var IteratorPlaceholderContent = OSView.Widget.IteratorPlaceholderContent;
    ...
    var View = (function (_super) {
        ...
        View.getBlocks = function() {
            return [OutSystemsUI_Private_PullToRefresh_mvc_view, Swayyy_Common_OfflineDataSyncEvents_mvc_view];
        };
        Object.defineProperty(View.prototype, "modelFactory", {
            get: function () {
                return Swayyy_Common_Layout_mvc_model;
            },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(View.prototype, "controllerFactory", {
            get: function () {
                return Swayyy_Common_Layout_mvc_controller;
            },
            enumerable: true,
            configurable: true
        });
...
_widgetRecordProvider: widgetsRecordProvider
}, React.createElement(Swayyy_Common_OfflineDataSyncEvents_mvc_view, {
inputs: {},
events: {
_handleError: function (ex) {
controller.handleError(ex);
...
define("Swayyy.Common.Layout.mvc$controller", ["OutSystems/ClientRuntime/Main", "Swayyy.model", "Swayyy.controller", "OutSystemsUI.controller", "Swayyy.languageResources", "Swayyy.clientVariables", "Swayyy.Common.Layout.mvc$debugger", "OutSystemsUI.controller$AddFavicon", "Swayyy.referencesHealth", "Swayyy.referencesHealth$OutSystemsUI", "OutSystemsUI.controller$LayoutReady", "OutSystemsUI.controller$SetLang", "OutSystemsUI.controller$SkipToContent"], function (OutSystems, SwayyyModel, SwayyyController, OutSystemsUIController, SwayyyLanguageResources, SwayyyClientVariables, Swayyy_Common_Layout_mvc_Debugger) {
var OS = OutSystems.Internal;
...
var vars = new OS.DataTypes.VariableHolder(new (controller.constructor.getVariableGroupType("Swayyy.Common.Layout.ActionHandler_OnSyncCompleteTrigger$vars"))());
vars.value.syncUnitInLocal = syncUnitIn;
varBag.callContext = callContext;
varBag.vars = vars;
OutSystemsDebugger.push("yitqNfsvyEys0AJ2G3CcWg:Th0iAdyqYke0exSEI7WZUg:/NRWebFlows.0eZ+W3SSVk+CJcw1X48PQA/NodesShownInESpaceTree.A3CPaT75a0KxzHXTIsSbxg/ClientActions.Th0iAdyqYke0exSEI7WZUg:eunz49Zr4oxMgskuTTHrFw", "Swayyy", "ActionHandler_OnSyncCompleteTrigger", "NRFlows.ClientScreenActionFlow", callContext.id, varBag);
OutSystemsDebugger.handleBreakpoint("yitqNfsvyEys0AJ2G3CcWg:zdEEGoFyh0O0X8sSFFssZg", callContext.id);
return OS.Flow.executeAsyncFlow(function () {
OutSystemsDebugger.handleBreakpoint("yitqNfsvyEys0AJ2G3CcWg:9+eATscBcUGq9JDrZ017eQ", callContext.id);
// Trigger Event: OnSyncComplete
return controller.onSyncComplete$Action(vars.value.syncUnitInLocal, callContext).then(function () {
OutSystemsDebugger.handleBreakpoint("yitqNfsvyEys0AJ2G3CcWg:jyVw_v_sgU6hJbgHkIPKnA", callContext.id);
});
}).then(function (res) {
OutSystemsDebugger.pop("yitqNfsvyEys0AJ2G3CcWg:Th0iAdyqYke0exSEI7WZUg", callContext.id);
return res;
...
Controller.registerVariableGroupType("Swayyy.Common.Layout.ActionHandler_OnSyncCompleteTrigger$vars", [{
name: "SyncUnit",
...
callContext = controller.callContext(callContext);
varBag.callContext = callContext;
try {OutSystemsDebugger.push("yitqNfsvyEys0AJ2G3CcWg:qitSK2Rm80mwxxjX7d_a6A:/NRWebFlows.0eZ+W3SSVk+CJcw1X48PQA/NodesShownInESpaceTree.A3CPaT75a0KxzHXTIsSbxg/ClientActions.qitSK2Rm80mwxxjX7d_a6A:XAkkfnZ1uRqNr0P1RCHazg", "Swayyy", "OnReady", "NRFlows.ClientScreenActionFlow", callContext.id, varBag);
OutSystemsDebugger.handleBreakpoint("yitqNfsvyEys0AJ2G3CcWg:tTNoJzHZMUyM8i60bD0qAw", callContext.id);
OutSystemsDebugger.handleBreakpoint("yitqNfsvyEys0AJ2G3CcWg:1atQWSYmeU60xXiAq6mv6Q", callContext.id);
// Execute Action: LayoutReady
OutSystemsUIController.default.layoutReady$Action(callContext);
OutSystemsDebugger.handleBreakpoint("yitqNfsvyEys0AJ2G3CcWg:wDcmb05rYkuaOoOIn71Qmg", callContext.id);
// Execute Action: SetLang
OutSystemsUIController.default.setLang$Action("", callContext);
OutSystemsDebugger.handleBreakpoint("yitqNfsvyEys0AJ2G3CcWg:mzLAB3gQz0WxRS4rcv7eXA", callContext.id);
// Execute Action: AddFavicon
OutSystemsUIController.default.addFavicon$Action("favicon.png", callContext);
OutSystemsDebugger.handleBreakpoint("yitqNfsvyEys0AJ2G3CcWg:8Vk2KE_oUUmyiqZsqOuOlg", callContext.id);
} catch (ex) {
OutSystemsDebugger.handleException(ex, callContext.id);
throw ex;
} finally {
OutSystemsDebugger.pop("yitqNfsvyEys0AJ2G3CcWg:qitSK2Rm80mwxxjX7d_a6A", callContext.id);
}
...
callContext = controller.callContext(callContext);
varBag.callContext = callContext;
OutSystemsDebugger.push("yitqNfsvyEys0AJ2G3CcWg:d37UXb2sj06bxYMMMWprOg:/NRWebFlows.0eZ+W3SSVk+CJcw1X48PQA/NodesShownInESpaceTree.A3CPaT75a0KxzHXTIsSbxg/ClientActions.d37UXb2sj06bxYMMMWprOg:ZXVij4oqSupuSyAmH_KChA", "Swayyy", "ActionHandler_OnPullToRefreshTrigger", "NRFlows.ClientScreenActionFlow", callContext.id, varBag);
OutSystemsDebugger.handleBreakpoint("yitqNfsvyEys0AJ2G3CcWg:kERdD8LDgE+J23uvzpqMVg", callContext.id);
return OS.Flow.executeAsyncFlow(function () {
OutSystemsDebugger.handleBreakpoint("yitqNfsvyEys0AJ2G3CcWg:3MkhZPZSUUKMdCUHdSKEZw", callContext.id);
// Trigger Event: OnPullToRefresh
return controller.onPullToRefresh$Action(callContext).then(function () {
OutSystemsDebugger.handleBreakpoint("yitqNfsvyEys0AJ2G3CcWg:Qs_5c_iidE+Fy49opuoRcA", callContext.id);
});
}).then(function (res) {
OutSystemsDebugger.pop("yitqNfsvyEys0AJ2G3CcWg:d37UXb2sj06bxYMMMWprOg", callContext.id);
return res;
...
callContext = controller.callContext(callContext);
var vars = new OS.DataTypes.VariableHolder(new (controller.constructor.getVariableGroupType("Swayyy.Common.Layout.ActionHandler_OnSyncErrorTrigger$vars"))());
vars.value.syncUnitInLocal = syncUnitIn;
vars.value.errorMessageInLocal = errorMessageIn;
varBag.callContext = callContext;
varBag.vars = vars;
OutSystemsDebugger.push("yitqNfsvyEys0AJ2G3CcWg:Z9dOYJFBuEeB+1DSu2B5dA:/NRWebFlows.0eZ+W3SSVk+CJcw1X48PQA/NodesShownInESpaceTree.A3CPaT75a0KxzHXTIsSbxg/ClientActions.Z9dOYJFBuEeB+1DSu2B5dA:O9AlNDbr+7ebcFopwEHtbA", "Swayyy", "ActionHandler_OnSyncErrorTrigger", "NRFlows.ClientScreenActionFlow", callContext.id, varBag);
OutSystemsDebugger.handleBreakpoint("yitqNfsvyEys0AJ2G3CcWg:bpdSPKfwc06uAGEZDNYGeQ", callContext.id);
return OS.Flow.executeAsyncFlow(function () {
OutSystemsDebugger.handleBreakpoint("yitqNfsvyEys0AJ2G3CcWg:8A1YH1U13E+ZfPzwwlPUag", callContext.id);
...
OutSystemsDebugger.handleBreakpoint("yitqNfsvyEys0AJ2G3CcWg:WMtEHNdfBECdT6zsjwRFqA", callContext.id);
});
}).then(function (res) {
OutSystemsDebugger.pop("yitqNfsvyEys0AJ2G3CcWg:Z9dOYJFBuEeB+1DSu2B5dA", callContext.id);
return res;
...
Controller.registerVariableGroupType("Swayyy.Common.Layout.ActionHandler_OnSyncErrorTrigger$vars", [{
name: "SyncUnit",
attrName: "syncUnitInLocal",
mandatory: true,
dataType: OS.Types.Text,
...
callContext = controller.callContext(callContext);
var vars = new OS.DataTypes.VariableHolder(new (controller.constructor.getVariableGroupType("Swayyy.Common.Layout.ActionHandler_OnSyncStartTrigger$vars"))());
vars.value.syncUnitInLocal = syncUnitIn;
varBag.callContext = callContext;
varBag.vars = vars;
OutSystemsDebugger.push("yitqNfsvyEys0AJ2G3CcWg:xkFabWL1UUyT8fm7uKmgOQ:/NRWebFlows.0eZ+W3SSVk+CJcw1X48PQA/NodesShownInESpaceTree.A3CPaT75a0KxzHXTIsSbxg/ClientActions.xkFabWL1UUyT8fm7uKmgOQ:GS0A_K_ODlU6vba9Vbituw", "Swayyy", "ActionHandler_OnSyncStartTrigger", "NRFlows.ClientScreenActionFlow", callContext.id, varBag);
OutSystemsDebugger.handleBreakpoint("yitqNfsvyEys0AJ2G3CcWg:kmWxeX59vkSpWn5AZqMLwQ", callContext.id);
return OS.Flow.executeAsyncFlow(function () {
OutSystemsDebugger.handleBreakpoint("yitqNfsvyEys0AJ2G3CcWg:cvW+l1AVnUSssp+DnbaqdQ", callContext.id);
// Trigger Event: OnSyncStart
return controller.onSyncStart$Action(vars.value.syncUnitInLocal, callContext).then(function () {
OutSystemsDebugger.handleBreakpoint("yitqNfsvyEys0AJ2G3CcWg:Wmo6YvJsGk+YHJkCLYY8gw", callContext.id);
});
}).then(function (res) {
OutSystemsDebugger.pop("yitqNfsvyEys0AJ2G3CcWg:xkFabWL1UUyT8fm7uKmgOQ", callContext.id);
return res;
...
Controller.registerVariableGroupType("Swayyy.Common.Layout.ActionHandler_OnSyncStartTrigger$vars", [{
name: "SyncUnit",
attrName: "syncUnitInLocal",
mandatory: true,
dataType: OS.Types.Text,
...
callContext = controller.callContext(callContext);
varBag.callContext = callContext;
try {OutSystemsDebugger.push("yitqNfsvyEys0AJ2G3CcWg:HqtXliUJCU2hV0e9Z4CEgw:/NRWebFlows.0eZ+W3SSVk+CJcw1X48PQA/NodesShownInESpaceTree.A3CPaT75a0KxzHXTIsSbxg/ClientActions.HqtXliUJCU2hV0e9Z4CEgw:2IJqvFTvG4KY0wJYjSElmA", "Swayyy", "SkipToContentOnClick", "NRFlows.ClientScreenActionFlow", callContext.id, varBag);
OutSystemsDebugger.handleBreakpoint("yitqNfsvyEys0AJ2G3CcWg:k6mkyv5TE0m24MLBDtmf7A", callContext.id);
OutSystemsDebugger.handleBreakpoint("yitqNfsvyEys0AJ2G3CcWg:BGOYVEyzeEul1cG8uoW7XA", callContext.id);
...
OutSystemsDebugger.handleBreakpoint("yitqNfsvyEys0AJ2G3CcWg:ZWG2kjwUSUCx8XuyRCDYLQ", callContext.id);
} catch (ex) {
OutSystemsDebugger.handleException(ex, callContext.id);
throw ex;
} finally {
OutSystemsDebugger.pop("yitqNfsvyEys0AJ2G3CcWg:HqtXliUJCU2hV0e9Z4CEgw", callContext.id);
}
...
OutSystemsDebugger.push("yitqNfsvyEys0AJ2G3CcWg:A3CPaT75a0KxzHXTIsSbxg:/NRWebFlows.0eZ+W3SSVk+CJcw1X48PQA/NodesShownInESpaceTree.A3CPaT75a0KxzHXTIsSbxg:cK6boJMNZEhNVkG_cG81Bg", "Swayyy", "Layout", "NRNodes.WebBlock", callContext.id, varBag);
};
Controller.prototype.popDebuggerContext = function (callContext) {
OutSystemsDebugger.pop("yitqNfsvyEys0AJ2G3CcWg:A3CPaT75a0KxzHXTIsSbxg", callContext.id);
...
define("Swayyy.Common.Layout.mvc$debugger", ["exports", "OutSystems/ClientRuntime/Debugger", "OutSystems/ClientRuntime/Main"], function (exports, Debugger, OutSystems) {
var OS = OutSystems.Internal;
var metaInfo = {
